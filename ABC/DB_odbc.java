...
class DB_odbc {  
	...
	public DB_odbc(Scanner sc)throws ClassNotFoundException, SQLException {
		 Class.forName("com.mysql.cj.jdbc.Driver");  
          conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/emp","root","Praju@123");  
          //obtain mysql
    ...
    public static void main(String args[]){  
        try{  
           ...
           ResultSet rs = stmt.executeQuery("select * from dep_mast");    
            while(rs.next())  {
    ...
    private void insert() throws SQLException{
    	...
    	String query = "INSERT INTO dep_mast VALUES(?, ?, ?)";
...
private void update() throws SQLException{
	...
	String query = "UPDATE dep_mast SET LOCATION= ? WHERE DEPT_NO=?";
	PreparedStatement preparedStatement = conn.prepareStatement(query);
...
private void delete() throws SQLException{
	int id=0;
	 ...
	 String query = "DELETE FROM dep_mast WHERE DEPT_NO = ?";
	 PreparedStatement preparedStatement =conn.prepareStatement(query);

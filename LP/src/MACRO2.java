...
class MACRO2 {
	...
	static void pass1() throws Exception {
		String s = new String();
		input = new BufferedReader(new InputStreamReader(new FileInputStream("D:\\input1.txt")));
		PrintWriter output = new PrintWriter(new FileOutputStream("D:\\output1_pass1.txt.txt"), true);
